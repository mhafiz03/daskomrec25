<div class="fixed hidden inset-0 flex items-center justify-center text-primary font-crimson-text bg-BlackLayer z-30" id="popupShift">
    <img src="assets/Stone Modal.webp" alt="Pop Up" class="absolute w-[600px] min-w-[300px] mx-10 sm:mx-3 pointer-events-none">
    <div class="absolute w-[300px] sm:w-[500px] mx-10 sm:mx-36">
        ...
        <div class="text-center mx-auto">
            ...
            <p class="lg:text-4xl md:text-3xl text-lg mt-1 md:mt-3 lg:mt-3 font-im-fell-english">Are you sure you want to <br> add this Gem?</p>
        </div>  
        <div class="mt-4 sm:mt-8 lg:mt-10 md:mt-10 flex justify-center space-x-4 ">
            <button class="relative text-primary transition-all duration-300 ease-in-out transform hover:scale-105 hover:brightness-125 active:scale-95 list-none cursor-Wand">
