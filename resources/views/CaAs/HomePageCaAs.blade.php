...
<body class="font-im-fell-english min-h-screen bg-HomePageCaAs bg-cover bg-center bg-no-repeat max-w-full overflow-x-hidden ">
    ...
    <img src="assets/Star 2.webp" 
     ...
     <div class="absolute inset-0 flex flex-col items-center justify-center z-10 text-center px-4">
          ...
          <p class="text-white py-2 text-lg font-bold leading-[32px] font-crimson-text md:text-xl md:leading-[24px] sm:text-sm sm:leading-[20px] fade-up" style="animation-delay: 3.2s">discover the light within</p>
      </div>
