...
<body class="font-im-fell-english flex flex-col ">
    ...
    <section class="relative h-screen bg-LandingCaas1 bg-cover bg-center overflow-x-hidden overflow-y-clip">
        ...
        <img src="assets/LeftUpperRock.png" id="Rock2" alt="Left Upper Rock" class="absolute -left-12 sm:left-0 top-0 w-[50vw] sm:w-[25vw] h-auto">
        
        
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4" >
            <img src="assets/Logo.png" alt="Logo" class="absolute top-20 w-auto h-8 sm:h-10 md:h-12">
        ...
        <img src="assets/Land.png" alt="Land" class="absolute bottom-0 w-full h-[60vh] sm:h-[100vh]" id="land1">


        <img src="assets/LeftBottomElement.png" alt="Bottom Left Element" class="absolute left-0 bottom-0 w-[40vw] sm:w-[35vw] md:w-[22vw] h-auto" id="BL-Element">
        <img src="assets/RightBottomElement.png" alt="Bottom Right Element" class="absolute right-0 bottom-0 w-[40vw] sm:w-[35vw] md:w-[23vw] h-auto" id="BR-Element">
        
    </section>
    <section class="relative h-screen bg-LandingCaas2 bg-cover bg-center overflow-x-hidden overflow-y-hidden">
        <img src="assets/Land.png" alt="Land" class="absolute top-0 w-full h-[100vh] scale-y-[-1]">
        <img src="assets/LandingShine.png" alt="Shine" class="absolute w-full h-[50vh]  -bottom-5">
        <img src="assets/RightBottomElement[2].png" alt="Shine" class="absolute w-[40vw] sm:w-[35vw] md:w-[22vw] h-auto right-0 bottom-0">
        <img src="assets/LeftBottomElement[2].png" alt="Shine" class="absolute w-[40vw] sm:w-[35vw] md:w-[22vw] h-auto left-0 bottom-0">
        <div class="absolute w-full h-full flex justify-center items-center overflow-y-hidden ">
            ...
            <img src="assets/Bubbles.gif" alt="Bubble" class="absolute right-10 bottom-5 w-[50vw] sm:w-[30vw] h-auto z-20 -rotate-90">
            <img src="assets/Bubbles.gif" alt="Bubble" class="absolute bottom-0 left-5 w-[80vw] sm:w-[30vw] h-auto z-0 -rotate-90">
