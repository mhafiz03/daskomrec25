        ...
        <div class="mt-16 relative justify-center">
            ...
            <div class="owl-carousel owl-theme justify-evenly mx-auto my-4">
                <div class="relative h-[410px] w-[200px] xs:w-[400px] flex justify-center items-center mx-auto">
                    <img src="assets/Gems Card/Gems (1).webp" alt="Gem Card" class="max-w-[250px] rounded">
                </div>  
                <div class="relative h-[410px] w-[200px] xs:w-[400px] flex justify-center items-center mx-auto">
                    <img src="assets/Gems Card/Gems (6).webp" alt="Gem Card" class="max-w-[250px] rounded">
                </div>  
                <div class="relative h-[410px] w-[200px] xs:w-[400px] flex justify-center items-center mx-auto">
                    <img src="assets/Gems Card/Gems (7).webp" alt="Gem Card" class="max-w-[250px] rounded">
                </div>  
                <div class="relative h-[410px] w-[200px] xs:w-[400px] flex justify-center items-center mx-auto">
                    <img src="assets/Gems Card/Gems (8).webp" alt="Gem Card" class="max-w-[250px] rounded">
                </div>  
                <div class="relative h-[410px] w-[200px] xs:w-[400px] flex justify-center items-center mx-auto">
                    <img src="assets/Gems Card/Gems (9).webp" alt="Gem Card" class="max-w-[250px] rounded">
                </div>    
            </div>
            <div class="flex justify-center h-[60px] space-x-2">
                ...
                <button class="text-primary transition-all duration-300 ease-in-out transform hover:scale-105 hover:brightness-150 active:scale-95" onclick="showGem()">
                    <img src="assets/Button Pink.webp" alt="Save" class="h-[75%] ">
